...
//					server_url = "http://42.121.111.191/mst/check_assets.php";
                ...
                function checkUpdate():void {
                    ...
                    HttpClient.send(server_url, {"p": Config.device, "v": version, "a": ConfigData.data_version}, onServerDownComplement,
                                    timeoutFunction);
                }
                ...
                function onServerDownComplement(obj:String):void {
                    ...
                    if (obj == "ok") {
                        ...
                        if (tmp_arr[0] == "update_assets") {
                            ...
                            AirAlert.getInstance().showAlert("", tmp_arr[1], "退出", AccountManager.instance.exitApp);
                        }
                    }
                }
