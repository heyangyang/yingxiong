package com.components
{
	...
	public class TabButton extends Sprite
	{
		...
		public function TabButton(upState:Texture, downState:Texture, text:String="")
		{
			...
			mEnabled=true;
			mUseHandCursor=true;
			mTextBounds=new Rectangle(0, 0, downState.width, downState.height);
			if (text.length != 0)
				this.text=text;
		...
		{
			return mTextField ? mTextField.fontSize : 24;
		}
		...
		{
			return mTextField ? mTextField.color : 0xffffff;
		}
