package com.view.base.event {
    ...
    public class EventType extends Event {
        ...
        public static const UPDATE_PACKAGE:String = "6";
        /**
         * 重置游戏
         */
        public static const RESET_GAME:String = "9";
        /**
         * 更新金币
         */
        ...
        /**选中标签页*/
        public static const SELECTTAB:String = "SELECTTAB";

        /**英雄装备替换 卸下 装备*/
        public static const SELECT_HERO_EQUIP:String = "SELECT_HERO_EQUIP";

        /**选中标地图章节*/
        public static const SELECT_MAP_ITEM:String = "SELECT_MAP_ITEM";
