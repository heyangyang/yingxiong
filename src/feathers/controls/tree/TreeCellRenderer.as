package feathers.controls.tree
{
	...
	public class TreeCellRenderer extends Sprite
	{
		...
		protected var icon:Scale9Image;
		...
		{
			this.labelTextField=new TextField(170, 24, "lable", "myFont", 24, 0xffffff);
			this.labelTextField.hAlign=HAlign.CENTER;
		}
		...
		protected function unSelectedBg():void
		{
			...
			{
				var scale9Textures:Scale9Textures=new Scale9Textures(AssetMgr.instance.getTexture("ui_huang01_01_anniu"), new Rectangle(14, 8, 121, 21));
				this.icon.textures=scale9Textures;
				this.icon.width=175;
				this.icon.height=50;
			}
		}
		...
		protected function setSelectedBg():void
		{
			if (_isSelected && this.icon && !hasChildNodes)
			{
				var scale9Textures:Scale9Textures=new Scale9Textures(AssetMgr.instance.getTexture("ui_huang01_02_anniu"), new Rectangle(14, 8, 121, 21));
				this.icon.textures=scale9Textures;
				this.icon.width=175;
				this.icon.height=50;
			}
		...
		{
			var scale9Textures:Scale9Textures;
			if (hasChildNodes)
			{
				scale9Textures=new Scale9Textures(AssetMgr.instance.getTexture("ui_hong03_01_anniu"), new Rectangle(26, 17, 65, 24));
				this.icon=new Scale9Image(scale9Textures, 1, true);
				this.icon.width=195;
				this.icon.height=70;
			}
			else
			{
				scale9Textures=new Scale9Textures(AssetMgr.instance.getTexture("ui_huang01_01_anniu"), new Rectangle(14, 8, 121, 21));
				this.icon=new Scale9Image(scale9Textures, 1, true);
				this.icon.width=175;
				this.icon.height=50;
			}
		...
		{
			var iconReference:Scale9Image=this.icon as Scale9Image;
			iconReference.y+=2;
			...
			this.labelTextField.y=((iconReference.height - this.labelTextField.height) >> 1) + iconReference.y + (hasChildNodes ? 0 : 5);
