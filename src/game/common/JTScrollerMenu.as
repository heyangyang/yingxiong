...
class JTMenuButton extends DefaultListItemRenderer
{
    ...
    public function JTMenuButton()
    {
        ...
        this.changeUpSkin=new Image(AssetMgr.instance.getTexture("ui_huang01_01_anniu"));
        this.defaultSkin=changeUpSkin;
        this.changeDownSkin=new Image(AssetMgr.instance.getTexture("ui_huang01_02_anniu"));
