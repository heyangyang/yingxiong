package game.manager {
    ...
    public class HeroDataMgr {
        ...
        public function getHerosMaxLv():int {
            var lv:int = 0;
            var vect:Vector.<*> = HeroDataMgr.instance.hash.values();
            for each (var heroData:HeroData in vect) {
        ...
        public function get seatMax():int {
            if (GameMgr.instance.tollgateID < 6) {
                ...
                return 3;
            } else if (GameMgr.instance.tollgateID < 37) {
                return 4;
            }
        ...
        public function getOpenTollgateId(heroNum:uint):int {
            ...
            var vect:Vector.<*> = HeroTotalData.hash.values();
            for each (var data:HeroTotalData in vect) {
