package game.net.message {
    ...
    import game.view.comm.HeroPriceDialog;
...
//            }
        ...
        private function updateForgeEquipNotify(info:SForge):void {
            if (DialogMgr.instance.isShow(BlacksmithDialog)) {
         ...
         *
         */
        public static function sendAutoEquip(heroData:HeroData, tmp_list:Vector.<WidgetData>):void {
            if (curr_hero) {
                return;
            }
            var weapon_id:int;
        ...
        private function strengthenNotify(info:SStrengthen):void {
            ...
            if (tip_msg != "")
                addTips(tip_msg);
            dispatch(EventType.NOTIFY_STRENGTHEN, {"isSuccess": info.code == 0 || info.code == 3, time: info.time});
            dispatch(EventType.UPDATE_POWER);
        }
        ...
        private function onPurgeNotify(info:SPurge):void {
            ...
            switch (info.code) {
                case 0:
                    ...
                    DialogMgr.instance.open(HeroPriceDialog, curr_hero);
                    break;
                case 1:
        ...
        private function onHeroDismissalNotify(info:SHeroDismissal):void {
            switch (info.code) {
                case 0:
                    ...
                    DialogMgr.instance.closeDialog(HeroInfoDialog);
                    break;
                case 3:
