package game.net.message
{
	...
	public class GameMessage extends Message
	{
		...
		public static function removeBackAllDialog():void
		{
			cur_dialogClass=[];
			cur_param=[];
		}
		...
		public static function addBackAllDialog(dialog:Class, param:Object):void
		{
			cur_dialogClass.push(dialog);
			cur_param.push(param);
		}
