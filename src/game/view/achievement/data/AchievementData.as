package game.view.achievement.data {
    ...
    public class AchievementData implements IObserver {
        ...
        /**小组分类 type 1：战斗  2：英雄  3：功能    4：竞技    5：其他   6：每日在线时长引导  	7：每日功能性引导       8：每日付费引导*/
                ...
                switch (getInfo.code) {
                    case 0:
                        ...
                        if (tmp_data && tmp_attainData) {
                            ...
                            if (tmp_attainData.goodsType == 5) { //英雄
                                ...
                                iconData.QualityTrue = Res.instance.getQualityHeroTextures(hero.quality);
                            ...
                            if (tmp_attainData.goodsType < 100 && tmp_attainData.goodsType != 5 || tmp_attainData.goodsType > 30000 && tmp_attainData.goodsType < 40000) {
