package game.view.activity {
    ...
    import game.view.activity.activity.AllGifts.FaceBookChannel;
    ...
    public class ActivitySection extends Sprite {
        ...
        public function ActivitySection() {
            super();
            classes(ActivityFirstPay, ActivityGifts, BindingGoodFriend, FriendCode, FriendLogin, MicroChannel, FaceBookChannel,
                    Rating, ActivityCodeView);
        }
