package game.view.activity.base.AllGiftsBase
{
    ...
    public class FaceBookBase extends View
    {
        ...
        public function FaceBookBase()
        {
            ...
            var ui_activities_diamond_search_weixin5711Texture:Texture=AssetMgr.instance.getTexture('ui_activities_diamond_search_facebook');
