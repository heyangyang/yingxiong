package game.view.comm
{
    ...
    public class GraphicsNumber
    {
        ...
        private static function createNumber(index:int=0, textureFirstName:String="ui_dengjishuzi_"):void
        {
            ...
            index++;
            if (index < 10)
                createNumber(index, textureFirstName);
        }

        public function getNumber(num:int, textureFirstName:String="ui_dengjishuzi_"):Sprite
        {
            ...
            for (var i:int=0; i < numStr.length; i++)
            {
                ...
                numImage.x=width > 0 ? (x + width - 5) : 0;
