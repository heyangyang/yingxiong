...
class EmBattleIndexGrid extends Sprite
{
	...
	{
		img_bg=new Image(AssetMgr.instance.getTexture("ui_dicengying03_jiemian"));
		addChild(img_bg);
	...
	public function showIndex():void
	{
		...
		text.visible=true;
		img_bg.texture=AssetMgr.instance.getTexture("ui_dicengying03_jiemian");
	}
	...
	public function showTag():void
	{
		...
		img_bg.texture=AssetMgr.instance.getTexture("ui_texingtubiao_0" + heroData.job);
		text.visible=false;
	}
