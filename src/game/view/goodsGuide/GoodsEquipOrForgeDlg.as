package game.view.goodsGuide {
    ...
    public class GoodsEquipOrForgeDlg extends Dialog {
        ...
        override protected function show():void {
            curr_hero = _parameter as HeroData;
        ...
        private function onChangeForgeViewHandler():void {
            //合成
            if (view_goodsInfo.btnok_Scale9Button.text == getLangue("forge")) {
            ...
            //装备/替换
            else if (view_goodsInfo.btnok_Scale9Button.text == getLangue("EQUIP") || view_goodsInfo.btnok_Scale9Button.text == getLangue("replace")) {
            ...
            //卸下
            else if (view_goodsInfo.btnok_Scale9Button.text == getLangue("noreplceNull")) {
