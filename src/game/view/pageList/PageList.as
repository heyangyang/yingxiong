package game.view.pageList {
    ...
    public class PageList extends Sprite {
        ...
        public function onPrev(e:Event = null):void {
            ...
            Starling.juggler.tween(child, 0.2, {x: -1000, onComplete: onComplete});
...
//			_select.prev.data.x = -1000;
            ...
            Starling.juggler.tween(_select.prev.data, 0.2, {x: _select.prev.data.pivotX, onComplete: onShow});
...
//			_select.next.data.x = -1000;
            ...
            Starling.juggler.tween(_select.next.data, 0.2, {x: _select.next.data.pivotX, onComplete: onShow});
