package game.view.rank.ui {
    ...
    public class JTUIHeroEquipment extends JTSprite {
        ...
        public function JTUIHeroEquipment() {
            ...
            var boxDi1:Image = new Image(AssetMgr.instance.getTexture('ui_daojukuangdi'));
            ...
            var boxDi2:Image = new Image(AssetMgr.instance.getTexture('ui_daojukuangdi'));
            ...
            var boxDi3:Image = new Image(AssetMgr.instance.getTexture('ui_daojukuangdi'));
            ...
            var boxDi4:Image = new Image(AssetMgr.instance.getTexture('ui_daojukuangdi'));
            ...
            var box1Texture:Texture = AssetMgr.instance.getTexture('ui_daojukuang01');
            ...
            var box2Texture:Texture = AssetMgr.instance.getTexture('ui_daojukuang01');
            ...
            var box3Texture:Texture = AssetMgr.instance.getTexture('ui_daojukuang01');
            ...
            var box4Texture:Texture = AssetMgr.instance.getTexture('ui_daojukuang01');
