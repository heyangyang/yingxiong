package game.view.rank.ui {
    ...
    public class JTUIRankItem extends JTSprite {
        ...
        public function JTUIRankItem() {
            ...
            var txture_ui_tubiao_duanwei343318:Texture = AssetMgr.instance.getTexture('icon_3');
            ...
            txt_item_name = new TextField(225, 50, '', '', 24, 0xFFEC48, false);
            txt_item_name.touchable = false;
            txt_item_name.hAlign = 'center';
            txt_item_name.x = 217;
            txt_item_name.y = 31;
            this.addQuiackChild(txt_item_name);
            txt_rank_info = new TextField(130, 35, '', '', 21, 0xFFFFFF, false);
