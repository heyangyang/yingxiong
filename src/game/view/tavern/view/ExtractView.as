...
//                addChild(starBar);
		...
		override protected function addListenerHandler() : void
		{
			...
			addContextListener(SSearchhero.CMD + "", handleNotification);
			addContextListener(SBuyhero.CMD + "", handleNotification);
		}
		...
		/**刷新返回数据*/
		private function handleNotification(event : Event, _arg1 : IData) : void
		{
			//刷新酒馆
			if (_arg1.getCmd() == SSearchhero.CMD)
			{
			...
			else if (_arg1.getCmd() == SBuyhero.CMD)
			{
