package  game.view.viewBase
{
    ...
    public class EquipRenderBase extends DefaultListItemRenderer
    {
        ...
        public function EquipRenderBase()
        {
            var texture:Texture;
            ...
            txt_name = new TextField(140,30,'','',20,0xFFFFCC,false);
            ...
            txt_count = new TextField(80,32,'','',21,0xFFFFCC,false);
            ...
            txt_needLevel.hAlign= 'left';
            txt_needLevel.text= '';
            txt_needLevel.x = 6;
            txt_needLevel.y = 1;
            this.addQuiackChild(txt_needLevel);
            txt_get = new TextField(80,36,'','',22,0x00FF00,false);
