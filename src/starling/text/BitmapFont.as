...
import starling.textures.Texture;
    ...
    public class BitmapFont
    {
        ...
        public function BitmapFont(texture:Texture=null, fontXml:XML=null)
        {
            ...
            if (fontXml) parseFontXml(mTexture,fontXml);
        }
        ...
        public function parseFontXml(mTexture:Texture,fontXml:XML):void
        {
        ...
        public function createSprite(sprite:Sprite,width:Number, height:Number, text:String,
