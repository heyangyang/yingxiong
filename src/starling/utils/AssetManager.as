package starling.utils
{
    ...
    public class AssetManager extends EventDispatcher
    {
        ...
        protected var _nameDic:Dictionary;
        /** helper objects */
        ...
        public function deleteHistory(path:String):void
        {
            delete _nameDic[path];
        }
        ...
        {
            if (mTextures[name]) return mTextures[name];
            else
            {
...
//            function onUrlLoaderComplete(event:Object):void
           function onUrlLoaderComplete(bytes:ByteArray):void
            {
//               var bytes:ByteArray = transformData(urlLoader.data as ByteArray, url);
            ...
            {
               if(urlLoader) urlLoader.data.clear();
            ...
            function complete(asset:Object):void
            {
                ...
                if (SystemUtil.isDesktop)
                    onComplete(asset,extension);
                else
                    SystemUtil.executeWhenApplicationIsActive(onComplete, asset,extension);
            }
        }
